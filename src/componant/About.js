    ...
    return (
        <section className="grid grid-cols-4 auto-rows-auto px-10 mt-10 lg:grid-cols-12 md:grid-cols-8 gap-x-5 gl:px-16 ">
            <div className="col-start-1 col-span-4 lg:col-start-3 lg:col-end-7 md:col-start-1 md:col-span-5">
                    ...
                    <p className="pt-3 pb-6 font-main text-Highlight-2 text-4xl">Chicago</p>
            ...
            <div className="col-start-1 col-span-4 justify-self-center col-end-4 flex h-fit justify-start md:col-start-6 md:justify-start md:col-span-3 md:mt-10 lg:col-start-7 lg:col-span-4 self-center">
                <img alt="photo_1" src={img1} className="w-40 h-52 rounded-md mt-12 lg:w-60 lg:h-80"/>
                <img alt="photo_2" src={img2} className="w-40 h-52 rounded-md ml-[-40px] z-50 lg:w-60 lg:h-80"/>
            </div>
        </section>
    )
}
