...
return(
    <section className="grid grid-cols-4 px-10 lg:grid-cols-12 md:grid-cols-8 gap-x-5 gl:px-16 bg-primary-2 h-fit">
            <div className="col-start-1 col-span-2 lg:col-start-3 lg:col-end-7 md:col-start-1 md:col-span-5">
                ...
                <button className="lg:w-52 md:w-48 w-40 lg:h-16 md:h-14 h-10 mb-4 bg-primary-1 rounded-lg text-Highlight-2 font-main lg:text-xl md:text-xl text-lg font-bold lg:mt-10">Reserve a table</button>
            </div>
            <img src={img1} alt="Main" className="object-fill col-start-3 col-span-2 mt-10 ml-10  justify-self-end self-center md:mt-10   md:justify-self-center lg:col-start-8 lg:col-span-3 rounded-lg lg:mt-2 lg:mb-[-15px] lg:h-[475px] lg:w-80 lg:ml-12 md:col-start-6 md:col-span-4  md:h-72 "/>
        </section>
)
}
export default Home;