...
const Card = (props) => {
    ...
    <p className="text-primary-2 col-start-1 col-span-2 h-fit  font-second line-clamp-3 hover:line-clamp-6  md:col-span-4 md:col-start-1 lg:order-4 lg:my-5 ">{props.descripion}</p>
    ...
    <button className="col-start-3 w-fill col-span-2 mt-2 md:mt-0 lg:mt-0 justify-self-center flex lg:order-5 lg:col-start-1 lg:col-span-3 lg:justify-self-start"><p className="self-center text-sm w-fit lg:text-base font-second font-bold">Order a delivery</p>
