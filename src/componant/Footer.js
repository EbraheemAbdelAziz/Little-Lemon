...
return(
    <footer className="grid grid-cols-4 auto-rows-auto px-10 gap-x-5 py-10 mt-5 bg-[#FBDABB] md:grid-cols-8 lg:grid-cols-12">
        ...
        <div className="col-start-1 col-span-2 order-1 md:justify-self-center lg:col-start-5 lg:order-2">
            ...
            <Link to={"https://EbraheemAbdelAziz.github.io/Little-Lemon/"} className="block">Home</Link>
            <Link to={"https://EbraheemAbdelAziz.github.io/Little-Lemon/"} className="block">About</Link>
            <Link to={"https://EbraheemAbdelAziz.github.io/Little-Lemon/"} className="block">Menu</Link>
            <Link to={"https://EbraheemAbdelAziz.github.io/Little-Lemon/"} className="block">Reservation</Link>
            <Link to={"https://EbraheemAbdelAziz.github.io/Little-Lemon/"} className="block">Order online</Link>
            <Link to={"https://EbraheemAbdelAziz.github.io/Little-Lemon/"} className="block">Login</Link>
        </div>
